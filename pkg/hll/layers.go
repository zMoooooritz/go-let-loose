...
var layers = map[string]Layer{
	...
	"PHL_L_1944_Warfare":             {ID: "PHL_L_1944_Warfare", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmWarfare, Environment: EnvDay},
	"PHL_L_1944_Warfare_Night":       {ID: "PHL_L_1944_Warfare_Night", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmWarfare, Environment: EnvNight},
	"PHL_L_1944_OffensiveUS":         {ID: "PHL_L_1944_OffensiveUS", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvDay},
	"PHL_L_1944_OffensiveGER":        {ID: "PHL_L_1944_OffensiveGER", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	"PHL_S_1944_Rain_P_Skirmish":     {ID: "PHL_S_1944_Rain_P_Skirmish", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmSkirmish, Environment: EnvRain},
	"PHL_S_1944_Morning_P_Skirmish":  {ID: "PHL_S_1944_Morning_P_Skirmish", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmSkirmish, Environment: EnvDawn},
	"PHL_S_1944_Night_P_Skirmish":    {ID: "PHL_S_1944_Night_P_Skirmish", GameMap: maps[MP_PURPLEHEARTLANE], GameMode: GmSkirmish, Environment: EnvNight},
	...
	"HIL_S_1944_Day_P_Skirmish":      {ID: "HIL_S_1944_Day_P_Skirmish", GameMap: maps[MP_HILL400], GameMode: GmSkirmish, Environment: EnvDay},
	"HIL_S_1944_Dusk_P_Skirmish":     {ID: "HIL_S_1944_Dusk_P_Skirmish", GameMap: maps[MP_HILL400], GameMode: GmSkirmish, Environment: EnvDusk},
