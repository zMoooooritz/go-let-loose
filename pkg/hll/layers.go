...
var layerMap = map[string]Layer{
	...
	"stmereeglise_offensive_ger":          {ID: "stmereeglise_offensive_ger", GameMap: mapMap[MP_STMEREEGLISE], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	...
	"SME_S_1944_Morning_P_Skirmish":       {ID: "SME_S_1944_Morning_P_Skirmish", GameMap: mapMap[MP_STMEREEGLISE], GameMode: GmSkirmish, Environment: EnvDawn},
	...
	"purpleheartlane_warfare":             {ID: "purpleheartlane_warfare", GameMap: mapMap[MP_PURPLEHEARTLANE], GameMode: GmWarfare, Environment: EnvDay},
	"purpleheartlane_warfare_night":       {ID: "purpleheartlane_warfare_night", GameMap: mapMap[MP_PURPLEHEARTLANE], GameMode: GmWarfare, Environment: EnvNight},
	"purpleheartlane_offensive_us":        {ID: "purpleheartlane_offensive_us", GameMap: mapMap[MP_PURPLEHEARTLANE], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvDay},
	"purpleheartlane_offensive_ger":       {ID: "purpleheartlane_offensive_ger", GameMap: mapMap[MP_PURPLEHEARTLANE], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	...
	"PHL_S_1944_Morning_P_Skirmish":       {ID: "PHL_S_1944_Morning_P_Skirmish", GameMap: mapMap[MP_PURPLEHEARTLANE], GameMode: GmSkirmish, Environment: EnvDawn},
	...
	"hurtgenforest_offensive_ger":         {ID: "hurtgenforest_offensive_ger", GameMap: mapMap[MP_HURTGENFOREST], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	"hill400_warfare":                     {ID: "hill400_warfare", GameMap: mapMap[MP_HILL400], GameMode: GmWarfare, Environment: EnvDay},
	"hill400_warfare_night":               {ID: "hill400_warfare_night", GameMap: mapMap[MP_HILL400], GameMode: GmWarfare, Environment: EnvNight},
	...
	"hill400_offensive_ger":               {ID: "hill400_offensive_ger", GameMap: mapMap[MP_HILL400], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	"HIL_S_1944_Day_P_Skirmish":           {ID: "HIL_S_1944_Day_P_Skirmish", GameMap: mapMap[MP_HILL400], GameMode: GmSkirmish, Environment: EnvDay},
	"HIL_S_1944_Dusk_P_Skirmish":          {ID: "HIL_S_1944_Dusk_P_Skirmish", GameMap: mapMap[MP_HILL400], GameMode: GmSkirmish, Environment: EnvDusk},
	"HIL_S_1944_Night_P_Skirmish":         {ID: "HIL_S_1944_Night_P_Skirmish", GameMap: mapMap[MP_HILL400], GameMode: GmSkirmish, Environment: EnvNight},
	...
	"FOY_S_1944_P_Skirmish":               {ID: "FOY_S_1944_P_Skirmish", GameMap: mapMap[MP_FOY], GameMode: GmSkirmish, Environment: EnvDay},
	"FOY_S_1944_Night_P_Skirmish":         {ID: "FOY_S_1944_Night_P_Skirmish", GameMap: mapMap[MP_FOY], GameMode: GmSkirmish, Environment: EnvNight},
	...
	"stalingrad_warfare":                  {ID: "stalingrad_warfare", GameMap: mapMap[MP_STALINGRAD], GameMode: GmWarfare, Environment: EnvDay},
	"stalingrad_warfare_night":            {ID: "stalingrad_warfare_night", GameMap: mapMap[MP_STALINGRAD], GameMode: GmWarfare, Environment: EnvNight},
	"stalingrad_offensive_rus":            {ID: "stalingrad_offensive_rus", GameMap: mapMap[MP_STALINGRAD], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvDay},
	"stalingrad_offensive_ger":            {ID: "stalingrad_offensive_ger", GameMap: mapMap[MP_STALINGRAD], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	...
	"remagen_offensive_ger":               {ID: "remagen_offensive_ger", GameMap: mapMap[MP_REMAGEN], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDay},
	...
	"KHA_S_1944_P_Skirmish":               {ID: "KHA_S_1944_P_Skirmish", GameMap: mapMap[MP_KHARKOV], GameMode: GmSkirmish, Environment: EnvDay},
	"KHA_S_1944_Night_P_Skirmish":         {ID: "KHA_S_1944_Night_P_Skirmish", GameMap: mapMap[MP_KHARKOV], GameMode: GmSkirmish, Environment: EnvNight},
	"driel_warfare":                       {ID: "driel_warfare", GameMap: mapMap[MP_DRIEL], GameMode: GmWarfare, Environment: EnvDay},
	...
	"mortain_warfare_evening":             {ID: "mortain_warfare_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmWarfare, Environment: EnvDawn},
	"mortain_warfare_night":               {ID: "mortain_warfare_night", GameMap: mapMap[MP_MORTAIN], GameMode: GmWarfare, Environment: EnvNight},
	...
	"mortain_offensiveUS_evening":         {ID: "mortain_offensiveUS_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvDawn},
	"mortain_offensiveger_evening":        {ID: "mortain_offensiveger_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDawn},
	"mortain_offensiveUS_night":           {ID: "mortain_offensiveUS_night", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvNight},
	"mortain_offensiveger_night":          {ID: "mortain_offensiveger_night", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvNight},
	...
	"mortain_skirmish_evening":            {ID: "mortain_skirmish_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmSkirmish, Environment: EnvDawn},
	"mortain_skirmish_night":              {ID: "mortain_skirmish_night", GameMap: mapMap[MP_MORTAIN], GameMode: GmSkirmish, Environment: EnvNight},
	...
	"elsenbornridge_warfare_evening":      {ID: "elsenbornridge_warfare_evening", GameMap: mapMap[MP_ELSENBORNRIDGE], GameMode: GmWarfare, Environment: EnvDusk},
	...
	"elsenbornridge_offensiveUS_evening":  {ID: "elsenbornridge_offensiveUS_evening", GameMap: mapMap[MP_ELSENBORNRIDGE], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvDusk},
	...
	"elsenbornridge_offensiveger_evening": {ID: "elsenbornridge_offensiveger_evening", GameMap: mapMap[MP_ELSENBORNRIDGE], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDusk},
	...
	"elsenbornridge_skirmish_evening":     {ID: "elsenbornridge_skirmish_evening", GameMap: mapMap[MP_ELSENBORNRIDGE], GameMode: GmSkirmish, Environment: EnvDusk},
