...
var layerMap = map[string]Layer{
	...
	"mortain_offensiveger_dusk":           {ID: "mortain_offensiveger_overcast", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvDusk},
	"mortain_offensiveger_overcast":       {ID: "mortain_offensiveger_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAxis, Environment: EnvOvercast},
	...
	"mortain_offensiveUS_dusk":            {ID: "mortain_offensiveUS_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmOffensive, Attackers: TmAllies, Environment: EnvDusk},
	...
	"mortain_warfare_dusk":                {ID: "mortain_warfare_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmWarfare, Environment: EnvDusk},
	...
	"mortain_skirmish_dusk":               {ID: "mortain_skirmish_evening", GameMap: mapMap[MP_MORTAIN], GameMode: GmSkirmish, Environment: EnvDusk},
