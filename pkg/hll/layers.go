...
var mapMap = map[Map]GameMap{
	...
	MP_MORTAIN:         {ID: MP_MORTAIN, Name: "MORTAIN", Tag: "MTN", PrettyName: "Mortain", ShortName: "Mortain", Allies: FctUS, Axis: FctGER, Orientation: OriHorizontal},
}
...
var layerMap = map[string]Layer{
	...
	"omahabeach_warfare_night":       {ID: "omahabeach_warfare_night", GameMap: mapMap[MP_OMAHABEACH], GameMode: GmWarfare, Environment: EnvNight},
	...
	"PHL_L_1944_Warfare":             {ID: "PHL_L_1944_Warfare", GameMap: mapMap[MP_PURPLEHEARTLANE], GameMode: GmWarfare, Environment: EnvDay},
