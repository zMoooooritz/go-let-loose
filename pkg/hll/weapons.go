...
const (
	...
	WEAPON_60L_SUPPLY                                   WeaponIdentifier = "60L (Supply)"
	WEAPON_60L_TRANSPORT                                WeaponIdentifier = "60L (Transport)"
	...
	WEAPON_ENFIELD_NO_2_MK_I                            WeaponIdentifier = "Enfield No.2 Mk I"
	...
	WEAPON_HALF_TRACK                                   WeaponIdentifier = "Half-track"
	...
	WEAPON_JEEP                                         WeaponIdentifier = "Jeep"
	...
	WEAPON_LANCHESTER                                   WeaponIdentifier = "Lanchester"
	...
	WEAPON_M2_BROWNING_HALF_TRACK                       WeaponIdentifier = "M2 Browning [Half-track]"
...
var weaponMap = map[WeaponIdentifier]Weapon{
	...
	WEAPON_ENFIELD_NO_2_MK_I: {
		ID:            WEAPON_ENFIELD_NO_2_MK_I,
		Name:          "Enfield No.2 Mk I",
		Type:          WEAPON_TYPE_REVOLVER,
		Factions:      []FactionIdentifier{FACTION_CAN},
		Magnification: 0,
	},
	WEAPON_FN_INGLIS_NO_2_MK_I: {
		ID:            WEAPON_FN_INGLIS_NO_2_MK_I,
	...
	WEAPON_60L_SUPPLY: {
		ID:            WEAPON_60L_SUPPLY,
		Name:          "Roadkill",
		Type:          WEAPON_TYPE_ROADKILL,
		Factions:      []FactionIdentifier{FACTION_CAN},
		Magnification: 0,
	},
	WEAPON_60L_TRANSPORT: {
		ID:            WEAPON_60L_TRANSPORT,
		Name:          "Roadkill",
		Type:          WEAPON_TYPE_ROADKILL,
		Factions:      []FactionIdentifier{FACTION_CAN},
		Magnification: 0,
	...
	WEAPON_M2_BROWNING_HALF_TRACK: {
		ID:            WEAPON_M2_BROWNING_HALF_TRACK,
		Name:          "M2 Browning",
		Type:          WEAPON_TYPE_MOUNTED_MG,
		Factions:      []FactionIdentifier{FACTION_CAN},
		Magnification: 0,
	...
	WEAPON_UNKNOWN: {
		...
		Name:          "Unknown",
		Type:          WEAPON_TYPE_UNKNOWN,
		Factions:      []FactionIdentifier{FACTION_GER, FACTION_US, FACTION_SOV, FACTION_CW, FACTION_DAK, FACTION_B8A, FACTION_CAN},
		Magnification: 0,
	},
	WEAPON_BOMBING_RUN: {
		...
		Factions:      []FactionIdentifier{FACTION_GER, FACTION_US, FACTION_CW, FACTION_DAK, FACTION_B8A, FACTION_CAN},
		Magnification: 0,
	},
	WEAPON_STRAFING_RUN: {
